...
![CM  Separator Setting and Styles](img/separator/setting-styles.jpg)
...
#### Settings
![CM  Separator Settings](img/separator/settings.png)
...
- The icon library allows for selecting the desired icon, with settings to adjust the icon size and gap between icon and separator. <br>
- Additionally, the alignment option determines whether the icon appears at the start, center, or end of the separator.

### Separator Styles
![CM  Separator Styles](img/separator/styles.png)
